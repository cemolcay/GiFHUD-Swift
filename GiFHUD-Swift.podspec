#
#  Be sure to run `pod spec lint GiFHUD-Swift.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.homepage     = "https://github.com/cemolcay/GiFHUD-Swift"
  ...
  s.source       = { :git => "https://github.com/cemolcay/GiFHUD-Swift.git", :tag => "v0.2" }
  ...
  s.source_files  = "GiFHUD-Swift/GiFHUD.swift"
